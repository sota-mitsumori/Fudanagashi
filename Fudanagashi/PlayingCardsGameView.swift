...
//import Combine
//
//// MARK: - ViewModel for Playing Cards
//
//class PlayingCardsGameViewModel: ObservableObject {
...
//    
//    @Published var previousCard: PlayingCard?
...
////    private let pastResultsKey = "pastResultsPlayingCards"
//    
//    @AppStorage("randomRotationPlayingCards") private var randomRotation: Bool = true
//    
...
//    @AppStorage("currentStreakPlayingCards") var currentStreak: Int = 0
//    @AppStorage("bestStreakPlayingCards") var bestStreak: Int = 0
//    
//    init() {
//        loadImages()
////        loadPastResults()
...
//    }
//    
//    func image(for card: PlayingCard) -> Image {
//        var uiImage = card.image
//        if card.isRotated {
//            if let cgImage = uiImage.cgImage {
//                uiImage = UIImage(cgImage: cgImage, scale: uiImage.scale, orientation: .down)
...
//    
//    func loadImages() {
//        var loadedCards: [PlayingCard] = []
//        for i in 1...52 { // Standard deck has 52 cards
//            let imageName = "playingcard\(i)" // Ensure your images are named playingCard1, playingCard2, ..., playingCard52
//            if let uiImage = UIImage(named: imageName) {
//                let isRotated = randomRotation ? Bool.random() : false
//                let card = PlayingCard(image: uiImage, isRotated: isRotated)
...
//}
//
//// MARK: - View for Playing Cards
//
//struct PlayingCardsGameView: View {
//    @StateObject var viewModel = PlayingCardsGameViewModel()
//    @State private var showSettings = false
//    @AppStorage("cardLayoutPlayingCards") private var cardLayout: String = "Single"
//    @AppStorage("randomRotationPlayingCards") private var randomRotation: Bool = true
//    
//    var body: some View {
...
//                        Image("background_finish_playing") // Use a different background if needed
//                            .resizable()
//                            .scaledToFit()
...
//                        Image("background_start_playing") // Use a different background if needed
//                            .resizable()
//                            .scaledToFit()
//                            .frame(maxWidth: geometry.size.width * 0.7)
//                            .position(x: geometry.size.width / 2, y: geometry.size.height / 3)
...
////                            Text("Best Score: \(String(format: "%.2f", bestScore)) seconds")
...
//                        }) {
//                            Text(viewModel.startTime == nil ? "Start" : "Restart")
//                                .font(.system(size: min(screenWidth, screenHeight) * 0.05))
...
//
//struct PlayingCardsGameResult: Codable, Identifiable {
//    let id: UUID
//    let date: Date
...
//// MARK: - Preview
//
//struct PlayingCardsGameView_Previews: PreviewProvider {
//    static var previews: some View {
//        PlayingCardsGameView(viewModel: PlayingCardsGameViewModel())
//    }
//}
